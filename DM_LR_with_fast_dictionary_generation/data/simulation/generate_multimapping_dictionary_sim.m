function D = generate_multimapping_dictionary_sim(new_T1_record,new_T2_record,new_B1_record,RR,xDoc)
...
centersegment = 43;
TNT_dur = zeros(n_images,1);
TNT_dur(1:9) = RR-(nr_startups+n_ex)*TR;
...
para_num = numel(new_T1_record);
para_list = [new_T1_record(:),new_T2_record(:),new_B1_record(:)];
